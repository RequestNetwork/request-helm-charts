# Request Node for xDA 0.5.5 Helm Chart

This chart allows you to deploy a Request Network node to be interoperable with xDAI based smart contracts . it will be an similar  IPFS server, on an Kubernetes cluster.it will be interacting with the openHashSubmitter on xDAI blockchain for  managing the  invocie hashes .
